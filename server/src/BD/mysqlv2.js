...
async function uno(tabla, id) {
    ...
    return result[0]; // Retornar solo primer elemento
}
...
async function agregar(tabla, data) {
    ...
    if (id === 0) {
        try {
            ...
            // Aquí no hace hash sino que inserta directamente
...
module.exports = { uno, todos, agregar, eliminar, login, actualizar, insertar };
